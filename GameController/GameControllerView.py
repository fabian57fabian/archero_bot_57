...
class GameControllerWindow(QWidget):
    def __init__(self, model: GameControllerModel, controller: GameControllerController):
        ...
        local_settings = self.model.engine.local_settings
        self.updateHealingStrategyChange(local_settings.healing_strategy)
        ...
        self.updateEnergyStrategyChange(local_settings.healing_strategy)
        ...
        self.updateVIPSubChange(local_settings.vip_sub)
        ...
        self.updateBattlepassAdvSubChange(local_settings.bpadv_sub)
        ...
        self.updateReviveIfDeadChange(local_settings.revive_ifdead)
        self.initConnectors()
